  ...
  return (
    <footer className="footer--container">
      <div className="footer--link--container">
        ...
        <div className="footer--social--icon">
          <ul>
            <li>
              <a
                href="https://www.facebook.com/kyungyean?mibextid=ZbWKwL"
            ...
            <li>
              <a
                href="https://www.instagram.com/kyungyeanson/?igshid=ZDdkNTZiNTM%3D/"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                href="https://twitter.com/KyungyeanS38452"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                href="https://www.linkedin.com/in/kyungyean-son-canada123/"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
      ...
      <div className="footer--content--container">
        <p className="footer--content">© Copyright 2023 Kyungyean Son</p>
        <div className="footer--social--icon">
          <ul>
            <li>
              <Link
